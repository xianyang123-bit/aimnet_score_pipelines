...
def _createPythonForce(*args):
    r"""_createPythonForce(computation, globalParameters={}, particles={}) -> PythonForce"""
...
class MonteCarloAnisotropicBarostat(Force):
    ...
    def getScaleMoleculesAsRigid(self):
        ...
        """
        return _openmm.MonteCarloAnisotropicBarostat_getScaleMoleculesAsRigid(self)
    ...
    def setScaleMoleculesAsRigid(self, rigid):
        ...
        """
        return _openmm.MonteCarloAnisotropicBarostat_setScaleMoleculesAsRigid(self, rigid)
    ...
    def __init__(self, *args):
        r"""
        __init__(self, defaultPressure, defaultTemperature, scaleX=True, scaleY=True, scaleZ=True, frequency=25, scaleMoleculesAsRigid=True) -> MonteCarloAnisotropicBarostat
...
class MonteCarloBarostat(Force):
    ...
    def getScaleMoleculesAsRigid(self):
        ...
        bool
            true if scaling is applied to molecule centroids, false if it is applied to each atom independently.
        """
        return _openmm.MonteCarloBarostat_getScaleMoleculesAsRigid(self)
    ...
    def setScaleMoleculesAsRigid(self, rigid):
        ...
        Set whether scaling is applied to the centroid of each molecule while keeping the molecules rigid, or to each atom independently.
        """
        return _openmm.MonteCarloBarostat_setScaleMoleculesAsRigid(self, rigid)
    ...
    def __init__(self, *args):
        r"""
        __init__(self, defaultPressure, defaultTemperature, frequency=25, scaleMoleculesAsRigid=True) -> MonteCarloBarostat
...
class MonteCarloFlexibleBarostat(Force):
    ...
    def computeStressTensor(self, context, includeKinetic=False):
        r"""
        computeStressTensor(self, context, includeKinetic=False)
        Compute the instantaneous stress tensor of a system to which this barostat is applied. The stress is estimated by a consistent strain finite difference: for each tensor component, a small deformation gradient is applied to both the atomic coordinates and all box vectors, and the potential energy is differentiated with respect to the strain.

        The returned values are in bar, with tension positive. When includeKinetic is true, the kinetic energy contribution is included as well. When getScaleMoleculesAsRigid() is true, coordinates are deformed by moving each molecule as a rigid unit.

        Parameters
        ----------
        context : Context
            the Context for which to compute the stress tensor
        stress : Sequence[float]
            on exit, the six independent elements in the order (XX, YY, ZZ, XY, XZ, YZ), in bar
        includeKinetic : bool
            if true, include the kinetic contribution to the stress tensor
        """
        val = _openmm.MonteCarloFlexibleBarostat_computeStressTensor(self, context, includeKinetic)
...
class MonteCarloMembraneBarostat(Force):
    ...
    def getScaleMoleculesAsRigid(self):
        ...
        bool
            true if scaling is applied to molecule centroids, false if it is applied to each atom independently.
        """
        return _openmm.MonteCarloMembraneBarostat_getScaleMoleculesAsRigid(self)
    ...
    def setScaleMoleculesAsRigid(self, rigid):
        ...
        Set whether scaling is applied to the centroid of each molecule while keeping the molecules rigid, or to each atom independently.
        """
        return _openmm.MonteCarloMembraneBarostat_setScaleMoleculesAsRigid(self, rigid)
    ...
    def __init__(self, *args):
        r"""
        __init__(self, defaultPressure, defaultSurfaceTension, defaultTemperature, xymode, zmode, frequency=25, scaleMoleculesAsRigid=True) -> MonteCarloMembraneBarostat
...
class PythonForce(Force):
    ...
    * </verbatim>
    ...
    A PythonForce can optionally be applied to only a subset of the particles in a system. To do this, call setParticles() on it, providing the indices of the particles to apply it to. The computation function should then proceed as if those particles were the entire system. state.getPositions() will return a smaller array containing only the positions of those particles, and the array of forces should similarly contain only those particles. That is, forces[i] should be the force on the i'th particle passed to setParticles(). When applying forces to only a small fraction of the particles in a system, this can greatly improve performance.
    ...
    def getParticles(self):
        r"""
        getParticles(self) -> vectori
        Get the indices of the particles to use when computing the force. If this is empty, all particles in the system will be used.
        """
        return _openmm.PythonForce_getParticles(self)

    def setParticles(self, particles):
        r"""
        setParticles(self, particles)
        Set the indices of the particles to use when computing the force. If this is empty, all particles in the system will be used.
        """
        return _openmm.PythonForce_setParticles(self, particles)
    ...
    def __init__(self, *args):
        r"""
        __init__(self, computation, globalParameters={}, particles={}) -> PythonForce
