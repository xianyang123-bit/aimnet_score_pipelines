...
pressure)
        ...
        subroutine OpenMM_MonteCarloFlexibleBarostat_computeStressTensor(target, context, &
stress, &
includeKinetic)
            use OpenMM_Types; implicit none
            type (OpenMM_MonteCarloFlexibleBarostat) target
            type (OpenMM_Context) context
            type (OpenMM_DoubleArray) stress
            integer*4 includeKinetic
        end subroutine
...
scaleMoleculesAsRigid)
        ...
        function OpenMM_MonteCarloAnisotropicBarostat_getScaleMoleculesAsRigid(target)
            use OpenMM_Types; implicit none
            type (OpenMM_MonteCarloAnisotropicBarostat) target
            integer*4 OpenMM_MonteCarloAnisotropicBarostat_getScaleMoleculesAsRigid
        end function
        subroutine OpenMM_MonteCarloAnisotropicBarostat_setScaleMoleculesAsRigid(target, rigid)
            use OpenMM_Types; implicit none
            type (OpenMM_MonteCarloAnisotropicBarostat) target
            integer*4 rigid
        end subroutine
...
scaleMoleculesAsRigid)
        ...
        function OpenMM_MonteCarloBarostat_getScaleMoleculesAsRigid(target)
            use OpenMM_Types; implicit none
            type (OpenMM_MonteCarloBarostat) target
            integer*4 OpenMM_MonteCarloBarostat_getScaleMoleculesAsRigid
        end function
        subroutine OpenMM_MonteCarloBarostat_setScaleMoleculesAsRigid(target, rigid)
            use OpenMM_Types; implicit none
            type (OpenMM_MonteCarloBarostat) target
            integer*4 rigid
        end subroutine
...
scaleMoleculesAsRigid)
        ...
        function OpenMM_MonteCarloMembraneBarostat_getScaleMoleculesAsRigid(target)
            use OpenMM_Types; implicit none
            type (OpenMM_MonteCarloMembraneBarostat) target
            integer*4 OpenMM_MonteCarloMembraneBarostat_getScaleMoleculesAsRigid
        end function
        subroutine OpenMM_MonteCarloMembraneBarostat_setScaleMoleculesAsRigid(target, rigid)
            use OpenMM_Types; implicit none
            type (OpenMM_MonteCarloMembraneBarostat) target
            integer*4 rigid
        end subroutine
