...
extern OPENMM_EXPORT void OpenMM_MonteCarloFlexibleBarostat_computeStressTensor(const OpenMM_MonteCarloFlexibleBarostat* target, OpenMM_Context* context, OpenMM_DoubleArray* stress, OpenMM_Boolean includeKinetic);
...
extern OPENMM_EXPORT OpenMM_MonteCarloAnisotropicBarostat* OpenMM_MonteCarloAnisotropicBarostat_create(const OpenMM_Vec3* defaultPressure, double defaultTemperature, OpenMM_Boolean scaleX, OpenMM_Boolean scaleY, OpenMM_Boolean scaleZ, int frequency, OpenMM_Boolean scaleMoleculesAsRigid);
...
extern OPENMM_EXPORT OpenMM_Boolean OpenMM_MonteCarloAnisotropicBarostat_getScaleMoleculesAsRigid(const OpenMM_MonteCarloAnisotropicBarostat* target);
extern OPENMM_EXPORT void OpenMM_MonteCarloAnisotropicBarostat_setScaleMoleculesAsRigid(OpenMM_MonteCarloAnisotropicBarostat* target, OpenMM_Boolean rigid);
...
/* MonteCarloBarostat */
extern OPENMM_EXPORT OpenMM_MonteCarloBarostat* OpenMM_MonteCarloBarostat_create(double defaultPressure, double defaultTemperature, int frequency, OpenMM_Boolean scaleMoleculesAsRigid);
...
extern OPENMM_EXPORT OpenMM_Boolean OpenMM_MonteCarloBarostat_getScaleMoleculesAsRigid(const OpenMM_MonteCarloBarostat* target);
extern OPENMM_EXPORT void OpenMM_MonteCarloBarostat_setScaleMoleculesAsRigid(OpenMM_MonteCarloBarostat* target, OpenMM_Boolean rigid);
...
extern OPENMM_EXPORT OpenMM_MonteCarloMembraneBarostat* OpenMM_MonteCarloMembraneBarostat_create(double defaultPressure, double defaultSurfaceTension, double defaultTemperature, OpenMM_MonteCarloMembraneBarostat_XYMode xymode, OpenMM_MonteCarloMembraneBarostat_ZMode zmode, int frequency, OpenMM_Boolean scaleMoleculesAsRigid);
...
extern OPENMM_EXPORT OpenMM_Boolean OpenMM_MonteCarloMembraneBarostat_getScaleMoleculesAsRigid(const OpenMM_MonteCarloMembraneBarostat* target);
extern OPENMM_EXPORT void OpenMM_MonteCarloMembraneBarostat_setScaleMoleculesAsRigid(OpenMM_MonteCarloMembraneBarostat* target, OpenMM_Boolean rigid);
