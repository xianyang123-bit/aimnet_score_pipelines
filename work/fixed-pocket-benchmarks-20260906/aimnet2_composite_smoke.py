...
The ligand is minimized in a fixed protein pocket with the gas model.
...
def main() -> None:
    ...
    parser.add_argument("--gas-model", default="aimnet2")
    ...
    pocket_ev = gas_energy(gas, pocket_coord.unsqueeze(0), pocket_numbers.unsqueeze(0),
    ...
    for index, mol in enumerate(poses):
        ...
        try:
            ...
            refined, complex_ev, bound_steps, bound_force, bound_converged, initial_complex_ev = minimize_in_pocket(
                gas, coord, numbers, charge, pocket_coord, pocket_numbers, pocket_charge,
            ...
            eint = (complex_ev - pocket_ev - egas) * EV_TO_KCAL_MOL
            ...
            row.update({
                ...
                "interaction_geometry": "fixed_pocket_gas_minimized_v1",
    ...
    summary = {
        ...
        "bound_refinement": "gas-phase ligand-in-fixed-pocket FIRE; no isolated bound refinement",
